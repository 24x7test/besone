        ...
        jQuery.ajax({
            ...
            success: function(req) {
                if (MOBILE_USE === '1') {
                    ...
                    var _x = jQuery('body').width() / 2 + jQuery(document).scrollLeft() - 250;
                    var _y = jQuery('body').height() / 2 + jQuery(document).scrollTop() - 200;
                    var _w = 380, _h = 200;
                }
                // ������ html�� ��üȭ ���Ѽ� �ʿ��� �κи� �̾� �´�.
                // �̷��� ���� ������ ������ html�� style�� ������ ��ü�� ������ ��ģ��.
...
function send(temp, temp2, is_unify_opt) {
    if(temp=="baro") {
